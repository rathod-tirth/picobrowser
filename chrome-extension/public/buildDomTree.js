  ...
  function buildDomTree(
    ...
    if (node.tagName) {
      ...
      if (tagName === "iframe") {
        ...
        const isRestrictiveSandbox =
          isSandboxed && !sandbox.includes("allow-same-origin");
        ...
        if (shouldSkipIframe) {
          ...
          nodeData.attributes["error"] =
            "Cross-origin iframe access blocked by sandbox";
        } else {
