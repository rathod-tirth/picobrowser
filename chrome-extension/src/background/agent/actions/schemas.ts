...
export const scrollToPercentActionSchema: ActionSchema = {
  ...
  schema: z.object({
    ...
    yPercent: z
      ...
      .int()
      .describe(
        "percentage to scroll to - min 0, max 100; 0 is top, 100 is bottom",
      ),
    index: z
      .number()
      .int()
...
export const scrollToTextActionSchema: ActionSchema = {
  ...
  schema: z.object({
    ...
    nth: z
      ...
      .default(1)
      .describe(
        "which occurrence of the text to scroll to (1-indexed, default: 1)",
      ),
  }),
};
