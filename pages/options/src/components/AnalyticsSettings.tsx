...
export const AnalyticsSettings: React.FC<AnalyticsSettingsProps> = ({
  ...
  const [settings, setSettings] = useState<AnalyticsSettingsConfig | null>(
    null,
  );
      ...
      <section className="space-y-6">
        ...
        >
          ...
          <div className="animate-pulse">
            <div
              className={`mb-2 h-4 w-3/4 rounded ${isDarkMode ? "bg-slate-600" : "bg-gray-200"}`}
            ></div>
            <div
              className={`h-4 w-1/2 rounded ${isDarkMode ? "bg-slate-600" : "bg-gray-200"}`}
            ></div>
          </div>
        </div>
      </section>
    ...
    <section className="space-y-6">
      ...
      >
        ...
        <div className="space-y-6">
          ...
          >
            <h3
              className={`text-base font-medium ${isDarkMode ? "text-gray-200" : "text-gray-700"} mb-4`}
            >
              What we collect:
            </h3>
            <ul
            ...
            >
              <li>
                Task execution metrics (start, completion, failure counts and
                duration)
              </li>
              <li>
                Domain names of websites visited (e.g., &quot;amazon.com&quot;,
                not full URLs)
              </li>
            ...
            <h3
              className={`mb-4 mt-6 text-base font-medium ${isDarkMode ? "text-gray-200" : "text-gray-700"}`}
            >
          ...
          {!settings.enabled && (
            ...
            >
              ...
              >
                Analytics disabled. You can re-enable it anytime to help improve
                Nanobrowser.
              </p>
            </div>
          )}
