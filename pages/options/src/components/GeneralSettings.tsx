...
export const GeneralSettings = ({
  ...
  const [settings, setSettings] = useState<GeneralSettingsConfig>(
    DEFAULT_GENERAL_SETTINGS,
  );
      ...
      >
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <h3
                className={`text-base font-medium ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}
              >
            ...
            <input
              ...
              onChange={(e) =>
                updateSetting("maxSteps", Number.parseInt(e.target.value, 10))
              }
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="relative inline-flex cursor-pointer items-center">
              <input
                ...
                onChange={(e) =>
                  updateSetting("displayHighlights", e.target.checked)
                }
                className="peer sr-only"
              />
              <label
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="relative inline-flex cursor-pointer items-center">
              <input
                ...
                onChange={(e) =>
                  updateSetting("replayHistoricalTasks", e.target.checked)
                }
                className="peer sr-only"
              />
              <label
