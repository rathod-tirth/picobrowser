  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        {!isSameActor && (
          <div
            className={`mb-1 text-sm font-semibold ${isDarkMode ? "text-gray-200" : "text-gray-900"}`}
          >
            {actor.name}
          </div>
        )}
        ...
        <div className="space-y-0.5">
          ...
          >
            {isProgress ? (
              <div
                className={`h-1 overflow-hidden rounded ${isDarkMode ? "bg-gray-700" : "bg-gray-200"}`}
              >
          ...
          {!isProgress && (
            <div
              className={`text-right text-xs ${isDarkMode ? "text-gray-500" : "text-gray-300"}`}
            >
